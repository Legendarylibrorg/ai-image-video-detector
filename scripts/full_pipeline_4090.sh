...
BEST_DS_MAX_PER_SOURCE_CLASS="${BEST_DS_MAX_PER_SOURCE_CLASS:-6000}"
BEST_DS_MAX_PER_SOURCE_SPLIT_CLASS="${BEST_DS_MAX_PER_SOURCE_SPLIT_CLASS:-1800}"
...
BEST_DS_HF_DISCOVERY_LIMIT="${BEST_DS_HF_DISCOVERY_LIMIT:-360}"
BEST_DS_HF_MAX_SOURCES="${BEST_DS_HF_MAX_SOURCES:-720}"
BEST_DS_HF_MIN_DOWNLOADS="${BEST_DS_HF_MIN_DOWNLOADS:-25}"
BEST_DS_HF_MIN_LIKES="${BEST_DS_HF_MIN_LIKES:-1}"
BEST_DS_HF_MIN_QUALITY_SCORE="${BEST_DS_HF_MIN_QUALITY_SCORE:-1.35}"
BEST_DS_HF_PRINT_TOP="${BEST_DS_HF_PRINT_TOP:-36}"
BEST_DS_HF_DISCOVERY_WORKERS="${BEST_DS_HF_DISCOVERY_WORKERS:-8}"
...
BEST_DS_STREAM_BUFFER_SIZE="${BEST_DS_STREAM_BUFFER_SIZE:-18000}"
BEST_DS_MAX_SAMPLES_PER_SOURCE="${BEST_DS_MAX_SAMPLES_PER_SOURCE:-18000}"
BEST_DS_ACCEPTANCE_WARMUP_SAMPLES="${BEST_DS_ACCEPTANCE_WARMUP_SAMPLES:-224}"
BEST_DS_MIN_ACCEPTANCE_RATE="${BEST_DS_MIN_ACCEPTANCE_RATE:-0.008}"
BEST_DS_MIN_HF_SOURCES_WITH_ACCEPTED="${BEST_DS_MIN_HF_SOURCES_WITH_ACCEPTED:-48}"
BEST_DS_MIN_HF_SOURCES_PER_CLASS="${BEST_DS_MIN_HF_SOURCES_PER_CLASS:-28}"
BEST_DS_MIN_HF_SOURCES_PER_SPLIT_CLASS="${BEST_DS_MIN_HF_SOURCES_PER_SPLIT_CLASS:-16}"
BEST_DS_REPO_BASE_PAUSE_MS="${BEST_DS_REPO_BASE_PAUSE_MS:-75}"
BEST_DS_REPO_JITTER_MS="${BEST_DS_REPO_JITTER_MS:-75}"
BEST_DS_REPO_COOLDOWN_MS="${BEST_DS_REPO_COOLDOWN_MS:-8000}"
BEST_DS_TRANSIENT_ERROR_COOLDOWN_MS="${BEST_DS_TRANSIENT_ERROR_COOLDOWN_MS:-1200}"
BEST_DS_MAX_CONSECUTIVE_FAILURES="${BEST_DS_MAX_CONSECUTIVE_FAILURES:-6}"
...
VIDEO_SNAPSHOT_MAX_WORKERS="${VIDEO_SNAPSHOT_MAX_WORKERS:-8}"
